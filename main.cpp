...
void show_fixed_vector(arr<T, N> &v) {
...
template<typename T, size_t N>
void test_push_back(arr<T, N> &v, int j) {
...
template<typename T, size_t N>
void test_insert_begin(arr<T, N> &v, int j) {
...
template<typename T, size_t N>
void test_insert_end(arr<T, N> &v, int j) {
...
template<typename T, size_t N>
void test_pop_back(arr<T, N> &v, int j) {
...
/*template<typename T, size_t N>
void test_resize(arr<T, N> &v, size_t size, T value) {
...
/*template<typename T, size_t N>
void test_assign(arr<T, N> &v, size_t size, T value) {
...
/*template<typename T, size_t N>
void test_clear(arr<T, N> &v, int j) {
...
/*template<typename T, size_t N>
void test_reserve(arr<T, N> &v, size_t size) {
